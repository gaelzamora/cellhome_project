      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8 h-10 w-full" aria-label="Global">
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
              ...
              >
                <Popover.Panel className="absolute z-10 overflow-hidden bg-white shadow-lg ring-1 ring-gray-900/5 w-screen">
                  <div className="p-4">
                    {store.map((item) => (
                      <div
                        key={item.name}
            ...
            <Popover className="relative">
              ...
              <Transition
                ...
                leaveTo="opacity-0 translate-y-1"
              >
                <Popover.Panel className="absolute z-10 w-screen overflow-hidden bg-white shadow-lg ring-1 ring-gray-900/5">
                  <div className="p-4">
                    {iphone.map((item) => (
                      <div
                        key={item.name}
          ...
          <Link to="#" className="text-xs font-semibold leading-6 text-gray-900">
            iPad
          </Link>
          <Link to="#" className="text-xs font-semibold leading-6 text-gray-900">
            Watch
