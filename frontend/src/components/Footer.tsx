    ...
    return(
        <footer className="bg-white shadow-lg">
            ...
            <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                ...
                <center><img src={cellhome} width={140} height={120}/></center>
            ...
            <div className="mt-12 border-t border-gray-200 pt-8">
                <p className="text-base text-gray-400 xl:text-center">Copyright &copy; 2023 CellHome Inc. Todos los derechos reservados</p>
            </div>
            </div>
      </footer>
    )
